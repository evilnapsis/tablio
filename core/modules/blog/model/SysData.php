...
// partiendo de que ya tenemos creado un objecto SysData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new SysData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new SysData());
	}
