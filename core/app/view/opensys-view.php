...
<div class="btn-toolbar">
	<a data-toggle="modal" href="#myModal" class="btn btn-default"><i class="fa fa-plus"></i> Nueva</a>
</div>
  <!-- Modal -->
...
<form class="form-horizontal" method="post" action="index.php?action=addtbl" role="form">
  ...
  <div class="form-group">
    ...
    <thead>
      ...
      <th></th>
		...
		<?php foreach($tables as $tbl):?>
			<tr>
			<td style="width:30px;"><a href="./index.php?view=playtable&tbl_id=<?php echo $tbl->id; ?>" class="btn btn-xs btn-default"><i class="fa fa-play"></i></a></td>
			<td style="width:30px;"><a href="./index.php?view=edittable&tbl_id=<?php echo $tbl->id; ?>" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a></td>
			<td><?php echo $tbl->name; ?>
			</td>
      <td style="width:30px;"><a href="./index.php?action=deltbl&tbl_id=<?php echo $tbl->id; ?>" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
      </td>
		<?php endforeach; ?>
	<?php else:?>
    <br>
    <div class="jumbotron">
    <h2>No hay tablas</h2>
    <p>Puedes empezar por crear una.</p>
    </div>	<?php endif; ?>
	</div>
	</div>
</div>