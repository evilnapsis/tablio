...
<div class="container">
	...
	<div class="row">
	<div class="col-md-6">
	<h2><?php echo $tbl->name; ?> <small>Insertar datos</small></h2>
</div>
	<div class="col-md-6">
<ol class="breadcrumb">
...
<tr>
      ...
      <?php $cnt++;
      endforeach; ?>
<td style="width:30px;"><a href="./index.php?action=delrow&row_id=<?php echo $r->id; ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-remove"></i></a></td>
</tr>
<?php endif; ?>
      <?php endforeach; ?>
...
<br>
    <div class="jumbotron">
    <h2>No hay datos</h2>
    <p>Puedes empezar por agregar algunos.</p>
    </div>  
	<?php endif; ?>
	</div>
	</div>
