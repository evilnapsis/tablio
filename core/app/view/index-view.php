...
<div class="btn-group">
	<a data-toggle="modal" href="#myModal" class="btn btn-default"><i class="fa fa-plus"></i> Nuevo</a>
</div>
  <!-- Modal -->
	...
	<?php if(count($syss)>0):?>
      ...
      <th></th>
		...
		<?php foreach($syss as $sys):?>
			<tr>
			<td style="width:100px;"><a href="./index.php?view=opensys&sys_id=<?php echo $sys->id; ?>" class="btn btn-xs btn-default"><i class="fa fa-chevron-right"></i> Tablas</a>
			</td>
			<td><?php echo $sys->name; ?>
			</td>
      <td style="width:30px;"><a href="./index.php?action=delsys&sys_id=<?php echo $sys->id; ?>" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
      </td>

		<?php endforeach; ?>
  <?php else:?>
    <div class="jumbotron">
    <h2>No hay sistemas</h2>
    <p>Puedes empezar por crear uno.</p>
    </div>
	<?php endif; ?>
	</div>
	</div>
