...
<?php endif; ?>
  ...
  <div class="form-group">
    ...
    <thead>
      ...
      <td><?php echo $r->is_required; ?>
      </td>
      <td style="width:70px;">
      <a data-toggle="modal" href="#edit<?php echo $r->id; ?>" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
      <a  href="./?action=delcol&id=<?php echo $r->id; ?>" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
...
<?php endif; ?>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" <?php if($r->is_required){ echo "checked";} ?> name="is_required"> Campo obligatorio
        </label>
      </div>
    </div>
  </div>
